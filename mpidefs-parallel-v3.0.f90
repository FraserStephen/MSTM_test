...
!      use mpi
      implicit none
      include 'mpif.h'
      integer :: mstm_mpi_comm_world,mstm_mpi_sum,mstm_mpi_max,mstm_mpi_min
         ...
         if(present(mpi_recv_buf_i).or.present(mpi_send_buf_i)) then
            ...
            if(mpi_command.eq.'gather') then
               if(present(mpi_send_buf_i)) then
                  ...
                  call mpi_gather(mpi_in_place,mpi_number,type,mpi_recv_buf_i,mpi_number,type, &
                               mpi_rank,comm,ierr)
               endif
               return
            endif
         ...
         if(present(mpi_recv_buf_r).or.present(mpi_send_buf_r)) then
            ...
            if(mpi_command.eq.'gather') then
               if(present(mpi_send_buf_r)) then
                  ...
                  call mpi_gather(mpi_in_place,mpi_number,type,mpi_recv_buf_r,mpi_number,type, &
                               mpi_rank,comm,ierr)
               endif
               return
            endif
         ...
         if(present(mpi_recv_buf_c).or.present(mpi_send_buf_c)) then
            ...
            if(mpi_command.eq.'gather') then
               if(present(mpi_send_buf_c)) then
                  ...
                  call mpi_gather(mpi_in_place,mpi_number,type,mpi_recv_buf_c,mpi_number,type, &
                               mpi_rank,comm,ierr)
               endif
               return
            endif
         ...
         if(present(mpi_recv_buf_dp).or.present(mpi_send_buf_dp)) then
            ...
            if(mpi_command.eq.'gather') then
               if(present(mpi_send_buf_dp)) then
                  ...
                  call mpi_gather(mpi_in_place,mpi_number,type,mpi_recv_buf_dp,mpi_number,type, &
                               mpi_rank,comm,ierr)
               endif
               return
            endif
         ...
         if(present(mpi_recv_buf_dc).or.present(mpi_send_buf_dc)) then
            ...
            if(mpi_command.eq.'gather') then
               if(present(mpi_send_buf_dc)) then
                  ...
                  call mpi_gather(mpi_recv_buf_dc,mpi_number,type,mpi_recv_buf_dc,mpi_number,type, &
                               mpi_rank,comm,ierr)
               endif
               return
            endif
